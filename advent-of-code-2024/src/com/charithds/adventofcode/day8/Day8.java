...
public class Day8 implements TaskInt {
    private final String DAY8_FILE;

    public Day8(String day8File) {
    ...
    private List<List<Integer>> getAntinodesPositions(List<Integer> pos1, List<Integer> pos2) {
        ...
        return List.of(antonode1, antonode2);
    }
...
//                    System.out.println("Processing positions: " + positions.get(i) + " and " + positions.get(j));
                    List<List<Integer>> antinodesPositions = getAntinodesPositions(positions.get(i), positions.get(j));
